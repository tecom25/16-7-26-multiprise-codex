...
export default function TelescopeLandingPage() {
  ...
  return (
    <main className="ts-site">
      ...
      <section className="ts-phone ts-section"><div className="ts-wrap ts-phone-grid">
        <div className="ts-phone-copy"><span>SUPPORT TÉLÉPHONE INCLUS</span><h2>Cadrez la Lune.<br /><em>Gardez le souvenir.</em></h2><p>Fixez votre smartphone devant l’oculaire pour cadrer l’image observée et photographier vos découvertes dans le ciel.</p><ul><li><b>01</b><span>Placez le téléphone dans le support</span></li><li><b>02</b><span>Alignez l’objectif avec l’oculaire</span></li><li><b>03</b><span>Réglez la mise au point et capturez</span></li></ul><a className="ts-primary" href="#commander">Je veux photographier le ciel <span>→</span></a><small>Le rendu dépend du téléphone, des conditions d’observation et des réglages.</small></div>
        <figure><img src="/telescope-phone-sky.png" alt="Smartphone fixé au support du télescope et photographiant la Lune" /><figcaption><span>●</span> Aperçu avec support téléphone</figcaption></figure>
      </div></section>
